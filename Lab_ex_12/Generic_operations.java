...
public class Generic_operations {
    public static void main(String[] args) {
        ...
        System.out.println("Enter the end index (0-8) to find the maximal elements in the specifying range2 : ");
        int end=obj.nextInt();
        if(begin>end) {
            System.out.println("Begin and end indices are invalid!\ni.e.Begin index is of greater value than the end index");
            return;
        }
...
class TestConditions {
    public<T extends Integer> void OddIntegers(T[] list) {
        ...
        if(count>0)
            ...
            System.out.println("\nThere are no odd integers in the list");
    }
